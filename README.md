...
- If you see a white screen, open browser DevTools and check for blocked CDN requests.
- Three.js imports use jsDelivr URLs; if your network blocks that domain too, mirror dependencies locally and update the import paths in `main.js`, `world.js`, and `humanoid.js`.
